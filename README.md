...
展示用户点击“解析当前视频”后，插件按步骤获取字幕、翻译字幕、生成总览并保存结果。

![解析进度](docs/assets/进度界面.jpeg)

#### 视频总览

展示当前视频的中文摘要、章节划分和关键点，帮助用户先建立整体理解。

![视频总览](docs/assets/总览界面.jpeg)

#### 中英字幕学习

展示逐句中英字幕，字幕会跟随 YouTube 当前播放进度高亮，适合边看边学。

![中英字幕学习](docs/assets/字幕界面.jpeg)

#### 针对字幕提问

展示用户基于选中的字幕内容向 AI 提问，AI 根据视频上下文给出解释。

![针对字幕提问](docs/assets/对话界面.jpeg)

#### 记录学习笔记

展示用户把关键字幕保存为笔记，并可以用 AI 重新整理成更适合复盘的中文表达。

![记录学习笔记](docs/assets/笔记界面.jpeg)

#### 生词和短语沉淀

展示从字幕中沉淀出的生词或短语，包括中文释义、来源字幕和例句生成入口。

![生词和短语沉淀](docs/assets/生词界面.jpeg)
